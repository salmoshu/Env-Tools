...
const DICT = {
  en: {
    ...
    // 升级浮层
    "upgrade.click": "Click to upgrade",
    ...
    "dash.resetChances": "Reset chances",
    "dash.resetRemaining": "{n} left",
    "dash.resetUsableNow": "usable now",
    "dash.resetAfterLimit": "usable after limit reached",
    "dash.resetChancesEarliest": "earliest exp.",
    ...
    "dash.kpiRate": "Token rate",
    "dash.rateWindow15": "last 15 min",
    "dash.rateLatestHint": "Latest active sessions",
    "dash.rateEndedAgo": "ended {d} ago",
    "dash.rateWindow60": "last 60 min",
  ...
  zh: {
    ...
    "dash.resetChances": "重置机会",
    "dash.resetRemaining": "剩余 {n} 次",
    "dash.resetUsableNow": "当前可用",
    "dash.resetAfterLimit": "达到上限后可用",
    "dash.resetChancesEarliest": "最早到期",
    ...
    "dash.kpiRate": "Token 速率",
    "dash.rateWindow15": "最近 15 分钟",
    "dash.rateLatestHint": "最近活跃会话",
    "dash.rateEndedAgo": "结束于 {d} 前",
    "dash.rateWindow60": "最近 60 分钟",
